...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 20
var buttonToggled = false

#hkbEvaluateExpressionModifier Values
@export var nodeName = "EvaluateExpressionModifier"
...
func _on_node_id_spin_box_value_changed(value):
	nodeID = value
	self.title = 'hkbEvaluateExpressionModifier - #' + str(nodeID)
