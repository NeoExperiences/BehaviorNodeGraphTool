...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 35
@export var nodeColorID = 0
var buttonToggled = false

#BSInterpValueModifier Values
@export var nodeName = "EventsFromRangeModifier"
@export var userData = 0
@export var enable = true
@export var inputValue = "0.0"
@export var lowerBound = "0.8999999761581421"
...
func _ready():
	...
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/inputValue/inputValueLine.text = inputValue
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/lowerBound/lowerBoundLine.text = lowerBound
...
func _on_inputValue_line_text_changed(new_text):
	inputValue = new_text

func _on_lowerBound_line_text_changed(new_text):
	lowerBound = new_text
