...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 42
@export var nodeColorID = 0
var buttonToggled = false

#hkbBehaviorReferenceGenerator Values
@export var nodeName = "BehaviorFileReference"
@export var userData = 0
@export var behaviorName = ""
...
func _ready():
	...
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/behaviorName/behaviorNameLine.text = behaviorName
...
func _on_node_id_spin_box_value_changed(value):
	nodeID = value
	self.title = 'hkbBehaviorReferenceGenerator - #' + str(nodeID)
...
func _on_behavior_name_line_text_changed(new_text):
	behaviorName = new_text
