...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 37
@export var nodeColorID = 0
var buttonToggled = false

#BSBehaviorGraphSwapGenerator Values
@export var nodeName = "BehaviorGraphSwapGenerator"
...
func _on_node_id_spin_box_value_changed(value):
	nodeID = value
	self.title = 'BSBehaviorGraphSwapGenerator - #' + str(nodeID)
