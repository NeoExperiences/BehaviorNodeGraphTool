...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 32
@export var nodeColorID = 0
var buttonToggled = false

#BSGetTimeStepModifier Values
@export var nodeName = "GetTimeStepModifier"
@export var userData = 0
@export var enable = true
@export var timeStep = "0.0"
...
func _ready():
	...
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/timeStep/timeStepLine.text = timeStep
...
func _on_node_id_spin_box_value_changed(value):
	nodeID = value
	self.title = 'BSGetTimeStepModifier - #' + str(nodeID)
...
func _on_time_step_line_text_changed(new_text):
	timeStep = new_text
