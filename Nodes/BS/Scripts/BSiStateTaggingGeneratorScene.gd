...
#Base Node Values
@export var nodeID = 0
@export var nodeTypeID = 46
@export var nodeColorID = 0
var buttonToggled = false

#BSiStateTaggingGenerator Values
@export var nodeName = "iStateTaggingGenerator"
@export var userData = 0
@export var iStateToSetAs = 0
@export var iPriority = 0
...
func _ready():
	...
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/iStateToSetAs/iStateToSetAsSpinBox.value = iStateToSetAs
	$DataPopupPanel/VBoxContainer/PanelContainer/FoldingPanel/iPriority/iPrioritySpinBox.value = iPriority
...
func _on_node_id_spin_box_value_changed(value):
	nodeID = value
	self.title = 'BSiStateTaggingGenerator - #' + str(nodeID)
...
func _on_i_state_to_set_as_spin_box_value_changed(value):
	iStateToSetAs = value

func _on_i_priority_spin_box_value_changed(value):
	iPriority = value
