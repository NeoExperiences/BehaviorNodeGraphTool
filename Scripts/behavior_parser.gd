...
func _parse_BSIsActiveModifier(file, node): # Done
	...
	file.store_string('            <hkparam name="bInvertActive0">' + str(node.bIsActiveArray[1]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bIsActive1">' + str(node.bIsActiveArray[2]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bInvertActive1">' + str(node.bIsActiveArray[3]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bIsActive2">' + str(node.bIsActiveArray[4]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bInvertActive2">' + str(node.bIsActiveArray[5]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bIsActive3">' + str(node.bIsActiveArray[6]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bInvertActive3">' + str(node.bIsActiveArray[7]) + '</hkparam>\r\n')
	file.store_string('            <hkparam name="bIsActive4">' + str(node.bIsActiveArray[8]) + '</hkparam>\r\n')
